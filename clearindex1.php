<?php
include_once 'C:\xampp\htdocs\ArtLink\controller\musicienC.php';
include_once 'C:\xampp\htdocs\ArtLink\model\Musician.php';
        ...
        <div class="page-content">
            <div class="page-header">
                <div class="container-fluid">
                    ...
                    <tr>
                        <td>
                            <?php echo $musician['nom_musician']." ".$musician['prenom_musician']; ?>
                        </td>
                        <td>
                            <a href="supprimerc.php?id=<?php echo $musician['id_musician']; ?>">Delete</a>
                        </td>
                        <td>
                            <a href="modifierc.php?id=<?php echo $categorie['id_musician']; ?>">Modify</a>
                        </td>
                    </tr>
        <?php endforeach; ?>
        </table>

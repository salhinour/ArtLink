...
<?php include_once 'include/header.php'; ?>
        ...
        <div class="page-content">
            <div class="page-header">
                <div class="container-fluid">
                    <h2 class="h5 no-margin-bottom">Tableau de bord</h2><br><br>
                    <section>
    ...
    foreach ($musicians as $musician): ?>
        <tr style="background-color: white;">
            <td>
                <?php echo $musician['nom_musician']; ?>
            </td>
            <td>
                <?php echo $musician['prenom_musician']; ?>
            </td>
            <td>
    ...
    <?php endforeach; ?>
        ...
        <div class="musicians-container"><br> <br>
